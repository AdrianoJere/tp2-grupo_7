...
const DATA = {
  ...
  apellido: 'GUTIERREZ',
  rol: 'DATA MAGE & DEV',
  descripcion: 'Apasionado de la tecnología y los datos. Stack principal: Python y SQL.',
  ...
  proyectos: [
    {
      nombre: 'Proyecto 1',
      emoji: '📊',
      descripcion: 'Proyecto de análisis de datos con Python y SQL. Procesamiento y visualización de datasets.',
    ...
    },
    {
      nombre: 'Proyecto 2',
      emoji: '💡',
      descripcion: 'Desarrollo web con HTML, CSS y JavaScript. Interfaces dinámicas y diseño responsivo.',
    ...
    },
    {
      ...
      emoji: '🕹️',
      descripcion: 'Sitio web estático con estética arcade para IFTS N°29. HTML, CSS y JS vanilla.',
      stack: ['HTML', 'CSS', 'JavaScript'],
